...
func enableAgentAuthentication(client kubernetesClient.Client, ctx context.Context, auth *automationconfig.Auth, agentKeyFileContents string, agentName string, opts authtypes.Options) error {
