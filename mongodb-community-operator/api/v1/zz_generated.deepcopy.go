...
func (in *ResourcesSpec) DeepCopyInto(out *ResourcesSpec) {
	*out = *in
	if in.MemberResources != nil {
		in, out := &in.MemberResources, &out.MemberResources
		*out = new(corev1.ResourceRequirements)
		(*in).DeepCopyInto(*out)
	}
	if in.MemberAgentResources != nil {
		in, out := &in.MemberAgentResources, &out.MemberAgentResources
		*out = new(corev1.ResourceRequirements)
		(*in).DeepCopyInto(*out)
	}
	...
	if in.ArbiterAgentResources != nil {
		in, out := &in.ArbiterAgentResources, &out.ArbiterAgentResources
		*out = new(corev1.ResourceRequirements)
		(*in).DeepCopyInto(*out)
	}
}
