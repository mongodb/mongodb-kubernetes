...
usage:
	...
	@ echo "  om-image:                   builds and pushes the Ops Manager docker image. Specify the download url using 'download_url'"
	@ echo "                              The url must point to the Ubuntu 16/18 tar.gz distro"
