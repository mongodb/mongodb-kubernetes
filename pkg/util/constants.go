...
const (
	...
	// MongoDbMultiController is the name of the MongoDB Multi controller
	MongoDbMultiController = "mongodbmulti-controller"
	...
	ENV_VAR_MULTI_CLUSTER_MODE = "MULTI_CLUSTER_MODE"
