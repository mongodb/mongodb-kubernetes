...
func resolveExternalAppDBProperties(ctx context.Context, operatorClusterClient kubeclient.Client, ref *omv1.ExternalApplicationDatabaseRef) AppDBProperties {
