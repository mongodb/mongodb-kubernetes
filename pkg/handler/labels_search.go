...
// EnqueueMemberClusterObjectToSearch is the handler.MapFunc form of
// MapMemberClusterObjectToSearch: it wraps the resolved request in a slice and
// drops objects missing the search-owner labels. Both search controllers use it
// to enqueue the central MongoDBSearch from member-cluster resource events.
