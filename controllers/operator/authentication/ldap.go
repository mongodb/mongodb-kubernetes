...
func (l *ldapAuthMechanism) EnableAgentAuthentication(ctx context.Context, _ kubernetesClient.Client, conn om.Connection, opts Options, log *zap.SugaredLogger) error {
