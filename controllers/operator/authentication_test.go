...
func TestUpdateOmAuthentication_EnableX509_TlsNotEnabled(t *testing.T) {
	...
	conn := om.NewMockedOmConnection(deployment.CreateFromReplicaSet("fake-mongoDBImage", rs))
...
func TestUpdateOmAuthentication_EnableX509_WithTlsAlreadyEnabled(t *testing.T) {
	...
	omConnectionFactory := om.NewCachedOMConnectionFactoryWithInitializedConnection(om.NewMockedOmConnection(deployment.CreateFromReplicaSet("fake-mongoDBImage", rs)))
