...
func TestX509AgentUserIsCorrectlyConfigured(t *testing.T) {
	...
	x509User := DefaultMongoDBUserBuilder().SetAuthSource(authentication.ExternalDB).SetDefaultDatabase(authentication.ExternalDB).SetMongoDBResourceName("my-rs").Build()
