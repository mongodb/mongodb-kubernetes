...
func TestUserReconciler_SavesConnectionStringForMultiShardedCluster(t *testing.T) {
	...
	reconciler := newMongoDBUserReconciler(ctx, kubeClient, omConnectionFactory.GetConnectionFunc, multiClusterProviderFromClientMap(memberClusterMap), testBackupEnableDelay)
...
func defaultUserReconciler(ctx context.Context, user *userv1.MongoDBUser) (*MongoDBUserReconciler, client.Client, *om.CachedOMConnectionFactory) {
	...
	return newMongoDBUserReconciler(ctx, kubeClient, omConnectionFactory.GetConnectionFunc, multiClusterProviderFromClientMap(memberClusterMap), testBackupEnableDelay), kubeClient, omConnectionFactory
}
