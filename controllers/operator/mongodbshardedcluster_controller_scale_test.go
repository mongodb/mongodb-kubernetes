...
func TestDistributedScaleUp_F9(t *testing.T) {
	...
	require.Equal(t, coordination.LeaseOtherClusterDone, leaderCoord.AcquireOrRespect(h.crKey, "shard-0", "cluster-c"), "expected component already Ready before scale-up")
