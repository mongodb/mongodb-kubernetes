...
import (
	...
	mdbcv1 "github.com/mongodb/mongodb-kubernetes/mongodb-community-operator/api/v1" //nolint:depguard // MCO scheme registration so community reconciliation tests can use the fake client
