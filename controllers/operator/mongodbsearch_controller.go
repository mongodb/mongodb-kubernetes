...
import (
	...
	mdbcv1 "github.com/mongodb/mongodb-kubernetes/mongodb-community-operator/api/v1" //nolint:depguard // MongoDBCommunity CRD type; search controller reconciles MongoDBSearch against community clusters
