...
func newExternalShardedConfig(routerHosts []string, shards []searchv1.ExternalShardConfig) *searchv1.ExternalShardedClusterConfig {
...
func TestShardedExternalSearchSource_Validate(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			spec: &searchv1.ExternalMongoDBSource{
				ShardedCluster: newExternalShardedConfig([]string{}, []searchv1.ExternalShardConfig{
		...
		},
		{
			...
			spec: &searchv1.ExternalMongoDBSource{
				ShardedCluster: newExternalShardedConfig([]string{"mongos.example.com:27017"}, []searchv1.ExternalShardConfig{}),
			},
			expectError:    true,
