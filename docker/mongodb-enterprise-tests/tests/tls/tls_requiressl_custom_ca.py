...
class TestReplicaSetWithTLSCreation(KubernetesTester):
    ...
    def test_operator_logs_tls_certificate(self, namespace):
        """There should be no warnings related to certificate generation, when the
        certs have not been generated by the operator."""
        ...
        assert SERVER_WARNING not in logs
        assert AGENT_WARNING not in logs
        assert MEMBER_AUTH_WARNING not in logs
