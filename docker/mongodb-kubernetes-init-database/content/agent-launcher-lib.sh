...
download_agent() {
    ...
    agent_base_url="https://s3.amazonaws.com/mciuploads/mms-automation/mongodb-mms-build-agent/builds/patches/6a5e4791b392b30007f3411b/automation-agent/local"
