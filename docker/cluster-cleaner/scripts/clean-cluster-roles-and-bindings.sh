...
for role in $(kubectl get clusterrole -o name | grep -E "mongodb-enterprise-operator|mdb-operator") ; do
...
for binding in $(kubectl get clusterrolebinding -o name | grep -E "mongodb-enterprise-operator|mdb-operator"); do
