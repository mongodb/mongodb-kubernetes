# This is a manual test deploying MongoDB on 2 clusters in GKE and EKS.
# Steps to execute:
...
@fixture(scope="module")
def mongodb_multi_unmarshalled(namespace: str, member_cluster_names: List[str]) -> MongoDB:
