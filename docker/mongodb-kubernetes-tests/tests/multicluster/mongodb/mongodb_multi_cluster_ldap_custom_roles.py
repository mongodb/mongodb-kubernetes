...
@mark.e2e_mongodb_multi_cluster_with_ldap_custom_roles
...
@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap_custom_roles
def test_create_mongodb_multi_with_ldap(mongodb_multi: MongoDB):
...
@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap_custom_roles
def test_ldap_user_can_write_to_database(mongodb_multi: MongoDB, user_ldap: MongoDBUser, ca_path: str):
...
def test_ldap_user_can_write_to_other_collection(mongodb_multi: MongoDB, user_ldap: MongoDBUser, ca_path: str):
...
@mark.e2e_mongodb_multi_cluster_with_ldap_custom_roles
@mark.xfail(reason="The user should not be able to write to a database/collection it is not authorized to write on")
def test_ldap_user_can_write_to_other_database(mongodb_multi: MongoDB, user_ldap: MongoDBUser, ca_path: str):
    testhelper.test_ldap_user_can_write_to_other_database(mongodb_multi, user_ldap, ca_path)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap_custom_roles
def test_automation_config_has_roles(mongodb_multi: MongoDB):
