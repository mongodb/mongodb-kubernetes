...
def mongodb_multi_a(
    ...
    resource = MongoDB.from_yaml(yaml_fixture("mongodb-multi.yaml"), MDB_RESOURCE, mdba_ns)
...
def mongodb_multi_b(
    ...
    resource = MongoDB.from_yaml(yaml_fixture("mongodb-multi.yaml"), MDB_RESOURCE, mdbb_ns)
    resource.set_version(custom_mdb_version)
...
@mark.e2e_mongodb_multi_cluster_recover_clusterwide
def test_create_mongodb_multi_nsa_nsb(mongodb_multi_a: MongoDB, mongodb_multi_b: MongoDB):
...
def test_delete_database_statefulsets_in_failed_cluster(
    mongodb_multi_a: MongoDB,
    mongodb_multi_b: MongoDB,
    mdba_ns: str,
    mdbb_ns: str,
    member_cluster_names: list[str],
    member_cluster_clients: List[MultiClusterClient],
...
@mark.e2e_mongodb_multi_cluster_recover_clusterwide
def test_mongodb_multi_nsa_enters_failed_stated(mongodb_multi_a: MongoDB):
    testhelper.test_mongodb_multi_nsa_enters_failed_stated(mongodb_multi_a)


@mark.e2e_mongodb_multi_cluster_recover_clusterwide
def test_mongodb_multi_nsb_enters_failed_stated(mongodb_multi_b: MongoDB):
...
@mark.e2e_mongodb_multi_cluster_recover_clusterwide
def test_mongodb_multi_nsa_recovers_removing_cluster(mongodb_multi_a: MongoDB):
    testhelper.test_mongodb_multi_nsa_recovers_removing_cluster(mongodb_multi_a)


@mark.e2e_mongodb_multi_cluster_recover_clusterwide
def test_mongodb_multi_nsb_recovers_removing_cluster(mongodb_multi_b: MongoDB):
