...
def unmanaged_mongodb_multi(
    ...
    resource = MongoDB.from_yaml(yaml_fixture("mongodb-multi.yaml"), MDB_RESOURCE, unmanaged_mdb_ns)
...
@mark.e2e_mongodb_multi_cluster_clusterwide
...
@mark.e2e_mongodb_multi_cluster_specific_namespaces
def test_create_mongodb_multi_nsa(mongodb_multi_a: MongoDB):
    testhelper.test_create_mongodb_multi_nsa(mongodb_multi_a)


@mark.e2e_mongodb_multi_cluster_specific_namespaces
def test_create_mongodb_multi_nsb(mongodb_multi_b: MongoDB):
    testhelper.test_create_mongodb_multi_nsb(mongodb_multi_b)


@mark.e2e_mongodb_multi_cluster_specific_namespaces
def test_create_mongodb_multi_unmanaged(unmanaged_mongodb_multi: MongoDB):
