...
@pytest.mark.e2e_mongodb_multi_cluster_replica_set
...
@pytest.mark.e2e_mongodb_multi_cluster_replica_set
def test_mongodb_options(mongodb_multi: MongoDB):
    testhelper.test_mongodb_options(mongodb_multi)


@pytest.mark.e2e_mongodb_multi_cluster_replica_set
def test_update_additional_options(mongodb_multi: MongoDB, central_cluster_client: kubernetes.client.ApiClient):
    testhelper.test_update_additional_options(mongodb_multi, central_cluster_client)


@pytest.mark.e2e_mongodb_multi_cluster_replica_set
def test_mongodb_options_were_updated(mongodb_multi: MongoDB):
...
@pytest.mark.e2e_mongodb_multi_cluster_replica_set
def test_cleanup_on_mdbm_delete(mongodb_multi: MongoDB, member_cluster_clients: List[MultiClusterClient]):
