...
@mark.e2e_mongodb_multi_cluster_disaster_recovery
...
@mark.e2e_mongodb_multi_cluster_disaster_recovery
@mark.e2e_mongodb_multi_cluster_multi_disaster_recovery
...
@mark.e2e_mongodb_multi_cluster_disaster_recovery
def test_delete_database_statefulset_in_failed_cluster(mongodb_multi: MongoDB, member_cluster_names: list[str]):
...
@mark.e2e_mongodb_multi_cluster_disaster_recovery
def test_replica_reaches_running(mongodb_multi: MongoDB):
    testhelper.test_replica_reaches_running(mongodb_multi)


@mark.e2e_mongodb_multi_cluster_disaster_recovery
@mark.e2e_mongodb_multi_cluster_multi_disaster_recovery
def test_number_numbers_in_ac(mongodb_multi: MongoDB):
