...
@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_mongodb_multi_pending(mongodb_multi: MongoDB):
    testhelper.test_mongodb_multi_pending(mongodb_multi)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_turn_tls_on_CLOUDP_229222(mongodb_multi: MongoDB):
    testhelper.test_turn_tls_on_CLOUDP_229222(mongodb_multi)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_multi_replicaset_CLOUDP_229222(mongodb_multi: MongoDB):
    testhelper.test_multi_replicaset_CLOUDP_229222(mongodb_multi)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_restore_mongodb_multi_ldap_configuration(mongodb_multi: MongoDB):
    testhelper.test_restore_mongodb_multi_ldap_configuration(mongodb_multi)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_create_ldap_user(mongodb_multi: MongoDB, user_ldap: MongoDBUser):
    testhelper.test_create_ldap_user(mongodb_multi, user_ldap)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_ldap_user_created_and_can_authenticate(mongodb_multi: MongoDB, user_ldap: MongoDBUser, ca_path: str):
    testhelper.test_ldap_user_created_and_can_authenticate(mongodb_multi, user_ldap, ca_path)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_ops_manager_state_correctly_updated(mongodb_multi: MongoDB, user_ldap: MongoDBUser):
    testhelper.test_ops_manager_state_correctly_updated(mongodb_multi, user_ldap)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_deployment_is_reachable_with_ldap_agent(mongodb_multi: MongoDB):
...
@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_new_ldap_user_can_authenticate_after_scaling(mongodb_multi: MongoDB, user_ldap: MongoDBUser, ca_path: str):
    testhelper.test_new_ldap_user_can_authenticate_after_scaling(mongodb_multi, user_ldap, ca_path)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_disable_agent_auth(mongodb_multi: MongoDB):
    testhelper.test_disable_agent_auth(mongodb_multi)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_mongodb_multi_connectivity_with_no_auth(mongodb_multi: MongoDB):
    testhelper.test_mongodb_multi_connectivity_with_no_auth(mongodb_multi)


@skip_if_static_containers
@mark.e2e_mongodb_multi_cluster_with_ldap
def test_deployment_is_reachable_with_no_auth(mongodb_multi: MongoDB):
