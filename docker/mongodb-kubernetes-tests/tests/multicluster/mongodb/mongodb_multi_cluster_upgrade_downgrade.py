...
@pytest.mark.e2e_mongodb_multi_cluster_upgrade_downgrade
def test_deploy_operator(multi_cluster_operator: Operator):
    testhelper.test_deploy_operator(multi_cluster_operator)


@pytest.mark.e2e_mongodb_multi_cluster_upgrade_downgrade
def test_create_mongodb_multi_running(mongodb_multi: MongoDB, custom_mdb_prev_version: str):
...
@pytest.mark.e2e_mongodb_multi_cluster_upgrade_downgrade
def test_mongodb_multi_upgrade(mongodb_multi: MongoDB, custom_mdb_prev_version: str, custom_mdb_version: str):
    testhelper.test_mongodb_multi_upgrade(mongodb_multi, custom_mdb_prev_version, custom_mdb_version)


@pytest.mark.e2e_mongodb_multi_cluster_upgrade_downgrade
def test_upgraded_replica_set_is_reachable(mongodb_multi: MongoDB):
    testhelper.test_upgraded_replica_set_is_reachable(mongodb_multi)


@pytest.mark.e2e_mongodb_multi_cluster_upgrade_downgrade
def test_mongodb_multi_downgrade(mongodb_multi: MongoDB, custom_mdb_prev_version: str):
    testhelper.test_mongodb_multi_downgrade(mongodb_multi, custom_mdb_prev_version)


@pytest.mark.e2e_mongodb_multi_cluster_upgrade_downgrade
def test_downgraded_replica_set_is_reachable(mongodb_multi: MongoDB):
