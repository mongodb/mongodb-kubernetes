...
@mark.e2e_mongodb_multi_cluster_backup_restore_no_mesh
...
class TestBackupForMongodb:
    ...
    def mongodb_multi_one_collection(self, mongodb_multi_one: MongoDB):
    ...
    @mark.e2e_mongodb_multi_cluster_backup_restore_no_mesh
    def test_mdb_ready(self, mongodb_multi_one: MongoDB):
