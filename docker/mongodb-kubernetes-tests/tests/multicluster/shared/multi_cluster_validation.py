...
class TestWebhookValidation(KubernetesTester):
    ...
    def test_unique_cluster_names(self, central_cluster_client: kubernetes.client.ApiClient, fixture: str):
    ...
    def test_only_one_schema(self, central_cluster_client: kubernetes.client.ApiClient, fixture: str):
        resource = yaml.safe_load(open(yaml_fixture(fixture)))
    ...
    def test_non_empty_clusterspec_list(self, central_cluster_client: kubernetes.client.ApiClient, fixture: str):
        resource = yaml.safe_load(open(yaml_fixture(fixture)))
