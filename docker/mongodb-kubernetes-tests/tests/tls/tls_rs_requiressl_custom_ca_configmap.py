"""
E2E tests for replica set TLS with requireSSL using ConfigMap custom CA.
"""
import pytest
...
MDB_RESOURCE_NAME = "test-tls-rs-custom-ca-configmap"
...
def mdb(namespace: str, server_certs: str, issuer_ca_configmap: str) -> MongoDB:
    resource = MongoDB.from_yaml(
        load_fixture("test-tls-base-rs-require-ssl-custom-ca.yaml"),
...
@pytest.mark.e2e_replica_set_tls_require_custom_ca_configmap
