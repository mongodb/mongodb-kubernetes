...
@fixture(scope="function")
def mc_replica_set(namespace: str,
                   mongodb_role_with_empty_strings: ClusterMongoDBRole,
                   mongodb_role_without_empty_strings: ClusterMongoDBRole,
                   third_project: str) -> MongoDBMulti:
...
def test_automation_config_has_roles(
    ...
    assert_expected_roles(mc_replica_set, replica_set, sharded_cluster, mongodb_role_with_empty_strings, mongodb_role_without_empty_strings)


def assert_expected_roles(mc_replica_set: MongoDBMulti,
                          replica_set: MongoDB,
                          sharded_cluster: MongoDB,
                          mongodb_role_with_empty_strings: ClusterMongoDBRole,
                          mongodb_role_without_empty_strings: ClusterMongoDBRole,
    ...
    rs_tester.assert_expected_role(role_index=0, expected_value=get_expected_role(mongodb_role_with_empty_strings["spec"]["role"]))
    ...
    rs_tester.assert_expected_role(role_index=1, expected_value=get_expected_role(mongodb_role_without_empty_strings["spec"]["role"]))
    sc_tester.assert_expected_role(role_index=0, expected_value=get_expected_role(mongodb_role_with_empty_strings["spec"]["role"]))
    sc_tester.assert_expected_role(role_index=1, expected_value=get_expected_role(mongodb_role_without_empty_strings["spec"]["role"]))
    mcrs_tester.assert_expected_role(role_index=0, expected_value=get_expected_role(mongodb_role_with_empty_strings["spec"]["role"]))
    mcrs_tester.assert_expected_role(role_index=1, expected_value=get_expected_role(mongodb_role_without_empty_strings["spec"]["role"]))
...
def test_change_inherited_role(
    ...
    def is_role_changed(ac_tester: AutomationConfigTester):
        return (ac_tester.get_role_at_index(0)["roles"][0]["role"] == "readWrite" and
                ac_tester.get_role_at_index(1)["roles"][0]["role"] == "read")
