...
def replica_set_single(namespace, custom_mdb_version: str):
    resource = MongoDB.from_yaml(yaml_fixture("replica-set-single.yaml"), namespace=namespace, name="replica-set-single")
    resource.configure(None, "replica-set")
    resource.set_version(custom_mdb_version)
    resource.create()
    return resource
...
def sharded_cluster_single(namespace, custom_mdb_version: str):
    resource = MongoDB.from_yaml(yaml_fixture("sharded-cluster-single.yaml"), namespace=namespace, name="sharded-cluster-single")
    resource.configure(None, "sharded-cluster")
    resource.set_version(custom_mdb_version)
    resource.create()
    return resource
