  ...
  - window_name: json
    ...
    panes:
      ...
      - shell_command:
          ...
          - retry_cmd "lnav /data/logs/mdb-debug/readiness/readiness.log.json"
      - shell_command:
      ...
      - shell_command:
          - tmux select-pane -t 0.11 -T '{{.ShortName}} (processes)'
          - retry_cmd "diffwatch --file /data/logs/mdb-debug/processes/processes.json --destDir /data/logs/mdb-debug/processes | tee -a /data/logs/mdb-debug/processes/processes.log"
  - window_name: logs{{.PodIdx}}
    ...
    panes:
      ...
      - shell_command:
          ...
          - retry_cmd "lnav /data/logs/automation-agent-verbose.log"
      - shell_command:
          - tmux select-pane -t 1.2 -T 'automation-agent-stderr.log'
          - retry_cmd "lnav /data/logs/automation-agent-stderr.log"
      - shell_command:
          - tmux select-pane -t 1.3 -T 'mongodb.log'
          - retry_cmd "lnav /data/logs/mongodb.log"
      - shell_command:
          - tmux select-pane -t 1.4 -T 'automation-agent.log'
          - retry_cmd "lnav /data/logs/automation-agent.log"
      - shell_command:
          - tmux select-pane -t 1.5 -T 'backup-agent.log'
          - retry_cmd "lnav /data/logs/backup-agent.log"
      - shell_command:
          - tmux select-pane -t 1.6 -T 'monitoring-agent.log'
          - retry_cmd "lnav /data/logs/monitoring-agent.log"
