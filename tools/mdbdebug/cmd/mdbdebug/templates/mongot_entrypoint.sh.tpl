...
container_log_file="${base_log_dir}/mongot_container.log"
...
while true; do
  ...
  if get_file "{{.Namespace}}" "{{.PodName}}" "${container_name}" "/mongot/config/config.yml" "${mongot_config_file}.yaml.tmp"; then
