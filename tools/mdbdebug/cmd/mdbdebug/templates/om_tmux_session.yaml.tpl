  ...
  - window_name: logs{{.PodIdx}}
    ...
    panes:
      - shell_command:
        ...
        - retry_cmd "less --follow-name +F /data/logs/mdb-debug/logs/mms-migration.log"
      - shell_command:
        - tmux select-pane -t 1.1 -T 'mms0-access.log'
        - retry_cmd "less --follow-name +F /data/logs/mdb-debug/logs/mms0-access.log"
      - shell_command:
        - tmux select-pane -t 1.2 -T 'mms0-startup.log'
        - retry_cmd "less --follow-name +F /data/logs/mdb-debug/logs/mms0-startup.log"
      - shell_command:
        - tmux select-pane -t 1.3 -T 'mms0.log'
        - retry_cmd "less --follow-name +F /data/logs/mdb-debug/logs/mms0.log"
