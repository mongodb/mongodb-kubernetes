  ...
  - window_name: json
    ...
    panes:
      ...
      - shell_command:
          ...
          - retry_cmd "lnav /data/logs/mdb-debug/readiness/readiness.log.json | tee -a /data/logs/mdb-debug/readiness/terminal_output.log"
      - shell_command:
  ...
  - window_name: logs{{.PodIdx}}
    ...
    panes:
      ...
      - shell_command:
          ...
          - retry_cmd "lnav /data/logs/mdb-debug/logs/automation-agent-verbose.log"
      - shell_command:
          - tmux select-pane -t 1.2 -T 'automation-agent-stderr.log'
          - retry_cmd "lnav /data/logs/mdb-debug/logs/automation-agent-stderr.log"
      - shell_command:
          - tmux select-pane -t 1.3 -T 'mongodb.log'
          - retry_cmd "lnav /data/logs/mdb-debug/logs/mongodb.log"
      - shell_command:
          - tmux select-pane -t 1.4 -T 'automation-agent.log'
          - retry_cmd "lnav /data/logs/mdb-debug/logs/automation-agent.log"
      - shell_command:
          - tmux select-pane -t 1.5 -T 'backup-agent.log'
          - retry_cmd "lnav /data/logs/mdb-debug/logs/backup-agent.log"
      - shell_command:
          - tmux select-pane -t 1.6 -T 'monitoring-agent.log'
          - retry_cmd "lnav /data/logs/mdb-debug/logs/monitoring-agent.log"
