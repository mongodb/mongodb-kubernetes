  ...
  - window_name: json
    ...
    panes:
      ...
      - shell_command:
        ...
        - retry_cmd "lnav /data/logs/mdb-debug/logs/pod.log | tee -a /data/logs/mdb-debug/logs/pod_viewer.log"
  - window_name: logs{{.PodIdx}}
    layout: even-horizontal
    panes:
      - shell_command:
        - tmux select-pane -t 1.0 -T 'daemon-startup.log'
        - retry_cmd "lnav /data/logs/mdb-debug/logs/daemon-startup.log | tee -a /data/logs/mdb-debug/logs/daemon-startup_viewer.log"
      - shell_command:
        - tmux select-pane -t 1.1 -T 'daemon.log'
        - retry_cmd "lnav /data/logs/mdb-debug/logs/daemon.log | tee -a /data/logs/mdb-debug/logs/daemon_viewer.log"
