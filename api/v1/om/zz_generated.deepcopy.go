...
func (in *AppDBSpec) DeepCopyInto(out *AppDBSpec) {
	*out = *in
	...
	if in.ManagedByMetaOM != nil {
		in, out := &in.ManagedByMetaOM, &out.ManagedByMetaOM
		*out = new(MetaOMRef)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetaOMRef) DeepCopyInto(out *MetaOMRef) {
	*out = *in
	out.CredentialsSecretRef = in.CredentialsSecretRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetaOMRef.
func (in *MetaOMRef) DeepCopy() *MetaOMRef {
	if in == nil {
		return nil
	}
	out := new(MetaOMRef)
