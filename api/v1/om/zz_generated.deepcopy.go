...
func (in *AppDB) DeepCopyInto(out *AppDB) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppDB.
func (in *AppDB) DeepCopy() *AppDB {
	if in == nil {
		return nil
	}
	out := new(AppDB)
