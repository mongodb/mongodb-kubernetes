...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MongoDBCustomRoleRef) DeepCopyInto(out *MongoDBCustomRoleRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MongoDBCustomRoleRef.
func (in *MongoDBCustomRoleRef) DeepCopy() *MongoDBCustomRoleRef {
	if in == nil {
		return nil
	}
	out := new(MongoDBCustomRoleRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Security) DeepCopyInto(out *Security) {
	*out = *in
	...
	if in.CustomRoleRefs != nil {
		in, out := &in.CustomRoleRefs, &out.CustomRoleRefs
		*out = make([]MongoDBCustomRoleRef, len(*in))
		copy(*out, *in)
	}
}
