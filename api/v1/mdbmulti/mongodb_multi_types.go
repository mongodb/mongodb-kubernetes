...
// to complete.
func (m *MongoDBMultiCluster) BuildConnectionString(username, password string, scheme connectionstring.Scheme, authSource string, connectionParams map[string]string) string {
	hostnames := make([]string, 0)
