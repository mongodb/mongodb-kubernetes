...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExternalAppDBRef) DeepCopyInto(out *ExternalAppDBRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExternalAppDBRef.
func (in *ExternalAppDBRef) DeepCopy() *ExternalAppDBRef {
	if in == nil {
		return nil
	}
	out := new(ExternalAppDBRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MongoDBOpsManagerSpec) DeepCopyInto(out *MongoDBOpsManagerSpec) {
	*out = *in
	...
	if in.ExternalAppDBRef != nil {
		in, out := &in.ExternalAppDBRef, &out.ExternalAppDBRef
		*out = new(ExternalAppDBRef)
		**out = **in
	}
	if in.Logging != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MongoDBOpsManagerValidator) DeepCopyInto(out *MongoDBOpsManagerValidator) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MongoDBOpsManagerValidator.
func (in *MongoDBOpsManagerValidator) DeepCopy() *MongoDBOpsManagerValidator {
	if in == nil {
		return nil
	}
	out := new(MongoDBOpsManagerValidator)
	in.DeepCopyInto(out)
	return out
}
