...
// importToolVersionMatchesOperator rejects a resource generated by the migrate-to-mck import tool
// when the tool's version does not match the operator's, since the generated spec is version-coupled.
func importToolVersionMatchesOperator(m *MongoDB) v1.ValidationResult {
