...
- [cluster_scoped_member_cluster.yaml](./resources/rbac/cluster_scoped_member_cluster.yaml) — ClusterRole/ClusterRoleBinding for a member cluster watching all namespaces (`--watched-namespaces "*"`).
