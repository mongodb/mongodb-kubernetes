...
# Override the user-supplied external host placeholders with the operator-managed
...
export MDB_EXTERNAL_HOST_0_0="${MDB_RESOURCE_NAME}-0-0-svc.${MDB_NS}.svc.cluster.local:27017"
export MDB_EXTERNAL_HOST_0_1="${MDB_RESOURCE_NAME}-0-1-svc.${MDB_NS}.svc.cluster.local:27017"
export MDB_EXTERNAL_HOST_1_0="${MDB_RESOURCE_NAME}-1-0-svc.${MDB_NS}.svc.cluster.local:27017"
export MDB_EXTERNAL_HOST_1_1="${MDB_RESOURCE_NAME}-1-1-svc.${MDB_NS}.svc.cluster.local:27017"
export MDB_CONNECTION_STRING="mongodb://mdb-user:${MDB_USER_PASSWORD}@${MDB_EXTERNAL_HOST_0_0},${MDB_EXTERNAL_HOST_0_1},${MDB_EXTERNAL_HOST_1_0},${MDB_EXTERNAL_HOST_1_1}/?replicaSet=${MDB_EXTERNAL_CLUSTER_NAME}&tls=true&tlsCAFile=/tls/ca.crt&authSource=admin&authMechanism=SCRAM-SHA-256"
