...
run 01_0307_prepare_cert_manager_issuer_auto_embedding.sh
run 01_0308_issue_tls_certificates.sh
run 01_0308_issue_tls_certificates_auto_embedding.sh

run 01_0310_create_mongodb_community_resource.sh
run 01_0312_create_mongodb_community_resource_auto_embedding.sh
run_for_output 01_0315_wait_for_community_resource.sh
run 01_0320_create_mongodb_search_resource.sh
run 01_0323_create_mongodb_search_resource_auto_embedding.sh
