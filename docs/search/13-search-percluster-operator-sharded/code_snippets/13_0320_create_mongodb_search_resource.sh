...
: "${MDBS_CLUSTER_0_EXTERNAL_HOSTNAME_TEMPLATE:?not set -- source the env files first (see README, Environment section)}"
...
: "${MDBS_CLUSTER_0_ROUTER_HOSTNAME:?not set -- source the env files first (see README, Environment section)}"
: "${MDBS_CLUSTER_1_EXTERNAL_HOSTNAME_TEMPLATE:?not set -- source the env files first (see README, Environment section)}"
...
: "${MDBS_CLUSTER_1_ROUTER_HOSTNAME:?not set -- source the env files first (see README, Environment section)}"
: "${MDBS_ENVOY_LB_REPLICAS:?not set -- source the env files first (see README, Environment section)}"
: "${MDBS_MONGOT_REPLICAS:?not set -- source the env files first (see README, Environment section)}"
...
: "${MDBS_TLS_CERT_SECRET_PREFIX:?not set -- source the env files first (see README, Environment section)}"
: "${MDB_MONGOS_HOST_0:?not set -- source the env files first (see README, Environment section)}"
: "${MDB_NAMESPACE:?not set -- source the env files first (see README, Environment section)}"
: "${MDB_SHARD_0_HOST_0:?not set -- source the env files first (see README, Environment section)}"
: "${MDB_SHARD_0_NAME:?not set -- source the env files first (see README, Environment section)}"
: "${MDB_SHARD_1_HOST_0:?not set -- source the env files first (see README, Environment section)}"
