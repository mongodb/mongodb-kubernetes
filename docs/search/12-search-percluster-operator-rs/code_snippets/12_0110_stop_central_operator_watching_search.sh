...
# operator to everything BUT mongodbsearch. The chart auto-watches mongodbmulticluster
# whenever multiCluster.clusters is set, so the ra-07 source is unaffected.
