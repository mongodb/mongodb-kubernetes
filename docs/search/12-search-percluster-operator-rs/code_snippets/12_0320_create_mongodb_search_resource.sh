...
: "${SEARCH_CLUSTER_0_NAME:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_CLUSTER_1_INDEX:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_CLUSTER_1_NAME:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_CLUSTER_2_INDEX:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_CLUSTER_2_NAME:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_ENVOY_LB_REPLICAS:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_MONGOT_REPLICAS:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_PROXY_SVC_0:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_PROXY_SVC_1:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_PROXY_SVC_2:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_RESOURCE_NAME:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_SOURCE_SEED_0_0:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_SOURCE_SEED_0_1:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_SOURCE_SEED_1_0:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_SOURCE_SEED_2_0:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_SOURCE_SEED_2_1:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_SYNC_USER_NAME:?not set -- source the env files first (see README, Environment section)}"
: "${SEARCH_TLS_CERT_SECRET_PREFIX:?not set -- source the env files first (see README, Environment section)}"
