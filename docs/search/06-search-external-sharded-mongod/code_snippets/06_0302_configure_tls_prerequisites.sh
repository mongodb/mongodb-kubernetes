...
# Create CA secret in the application namespace for external source TLS verification
...
echo "TLS prerequisites configured (CA issuer: ${MDB_TLS_CA_ISSUER}, CA secret: ${MDB_TLS_CA_SECRET_NAME})"
