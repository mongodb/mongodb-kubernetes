...
run 0305_create_mongodb_database_resource.sh
run 0310_wait_for_database_resource.sh
run 0315_create_mongodb_users.sh
run 0320_create_mongodb_search_resource.sh
run 0325_wait_for_search_resource.sh
run 0330_wait_for_database_resource.sh
