# Start from a normal Ops Manager with an internally-managed AppDB (spec.applicationDatabase).
# This is the "before" state we will migrate away from.
...
echo "[ok] Primary Ops Manager '${PRIMARY_OM_NAME}' created with an internal AppDB"
