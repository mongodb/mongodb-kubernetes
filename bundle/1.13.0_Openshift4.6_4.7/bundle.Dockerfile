...
COPY 1.13.0_Openshift4.6_4.7/manifests /manifests/
COPY 1.13.0_Openshift4.6_4.7/metadata /metadata/
COPY 1.13.0_Openshift4.6_4.7/tests/scorecard /tests/scorecard/
