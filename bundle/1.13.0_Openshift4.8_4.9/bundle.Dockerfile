...
COPY 1.13.0_Openshift4.8_4.9/manifests /manifests/
COPY 1.13.0_Openshift4.8_4.9/metadata /metadata/
COPY 1.13.0_Openshift4.8_4.9/tests/scorecard /tests/scorecard/
