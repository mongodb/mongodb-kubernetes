...
class PlatformConfiguration:
    ...
    def generate_agent_build_args(
        self, platforms: List[str], agent_version: str, tools_version: str, agent_base_url: str = None
    ) -> Dict[str, str]:
        """
...
def generate_agent_build_args(
    platforms: List[str], agent_version: str, tools_version: str, agent_base_url: str = None
) -> Dict[str, str]:
    """Generate build arguments for agent image based on platform mappings."""
...
def get_working_agent_filename(agent_version: str, platform: str, agent_base_url: str = None) -> str:
    """
