...
def build_operator_image_fast(build_configuration: ImageBuildConfiguration) -> bool:
    ...
    image_repo = build_configuration.registry + "/" + build_configuration.image_type + "/mongodb-kubernetes"
    image_tag = "latest"
