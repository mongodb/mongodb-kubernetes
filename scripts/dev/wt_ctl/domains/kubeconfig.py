        ...
        *,
        ...
        if evg_pin.is_file():
            ...
            if evg_host_proxy:
                ...
                _pin_current_context(devc_data)
        ...
        if m:
            ...
            shutil.copyfile(host_kc, devc_kc)
