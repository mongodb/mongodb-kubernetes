...
# OPERATOR_IMAGE must match what 'make operator-image' pushes (see build_info.json patch scenario and Makefile DEV_VERSION)
...
OPERATOR_IMAGE=\"${OPERATOR_REGISTRY:-${REGISTRY}}/mongodb-kubernetes:${DEV_VERSION:-${OPERATOR_VERSION:-latest}}${OPERATOR_BUILD:-}\"
