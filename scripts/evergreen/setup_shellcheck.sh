...
curl --retry 10 --retry-delay 10 --retry-all-errors --max-time 300 -fsSL "https://github.com/koalaman/shellcheck/releases/download/${shellcheck_version}/shellcheck-${shellcheck_version}.linux.x86_64.tar.xz" -o "${shellcheck_archive}"
